...
inc_g=[0,0,0,0,0,0]
for i in range(0,6):
    g[i]=4*(math.pi**2)*0.788*(1/(T[i]**2))                    #l=0.79+- 0.05  #filo 2 = 0.688 +- 0.001 
    inc_g[i]=math.sqrt(   pow(4*(math.pi**2)*0.0011*(1/(T[i]**2)),2)  +  pow((8*(math.pi**2)*0.788*inc_T[i]*(1/(T[i]**3))),2))    
"""
